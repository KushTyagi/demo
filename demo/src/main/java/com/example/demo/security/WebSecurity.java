...
public class WebSecurity extends WebSecurityConfigurerAdapter{
	...
	org.springframework.web.cors.reactive.CorsConfigurationSource corsConfigurationSource() {
		final UrlBasedCorsConfigurationSource urlBasedConf = new UrlBasedCorsConfigurationSource();
		urlBasedConf.registerCorsConfiguration("/**", new CorsConfiguration().applyPermitDefaultValues());
		return urlBasedConf;
	}
}
