...
public class GenericDao<T> implements GenericRepo<T>{*/
    ...
    private Class<T> type;*/
     ...
     /* public T create(T t) {
		...
		/*
		 * @Override public List<T> getUser() { List<T> list = null; try { Query qury =
		 * em.createNativeQuery("select *from user"); list = qury.getResultList();
		 * 
    ...
    public T update(T t, long id) {
    	Object obj = (Object)t;
    		try {
    			...
    			Responsebean bean = new Responsebean("309","Not updated some exception occured");
    			//e.printStackTrace();
    			return (T)bean;
    		}
